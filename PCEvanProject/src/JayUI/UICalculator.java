...
public class UICalculator extends JFrame implements KeyListener, ActionListener{
	// Variables
...
//		GridLayout(int rows, int cols, int hgap, int vgap) 
		...
		jbnButtons[19] = new JButton("CE");
		jplBackSpace.add(jbnButtons[19]);
		jplControl = new JPanel();
		jplControl.setLayout(new GridLayout(1, 2, 2 ,2));
		jbnButtons[20] = new JButton("C");
...
//		Setting all Numbered JButton's to Blue. The rest to Red
		...
		jplButtons.setLayout(new GridLayout(4, 2, 2, 2));
...
if ((!inputString.equals("0") || digit > 0)  && inputString.length() < MAX_INPUT_LENGTH){
	...
	void clearAll()	{
		setDisplayString(String.format("%f", BackgroundMain2.totalPrice) );
		lastOperator = "0";
		lastNumber = 0;
		displayMode = INPUT_MODE;
	...
	public void keyPressed(KeyEvent e) {
		// TODO Auto-generated method stub
		System.out.print("Keypressed calculator");
